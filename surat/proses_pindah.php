...
$sql = "SELECT * FROM `penduduk` JOIN `surat_pindah_temp` ON `penduduk`.id_penduduk = `surat_pindah_temp`.id_penduduk WHERE `surat_pindah_temp`.id_penduduk = '$get_id_penduduk'";
