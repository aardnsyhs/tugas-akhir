...
$query_kk = "SELECT * FROM kk JOIN penduduk ON kk.id_penduduk=penduduk.id_penduduk WHERE kk.id_penduduk = '$id'";
...
$cek_data_kk = mysqli_fetch_assoc($hasil_kk);
if (!$cek_data_kk) {
...
$pdf->cell(2, 7, ':', 0, 0, 'L');
$pdf->cell(80, 7, substr(strtoupper($cek_data_kk['no_kk']), 0, 20), 0, 1, 'L');
